     ...
     if(this.props.backgroundImage){
       return (
          <View style={{backgroundColor:'white',margin:this.props.padding*xsize}}>
            ...
            {this.displayLogo()}
             <Svg ref={this.props.getRef} style={{backgroundColor:'transparent',height:this.props.size,width:this.props.size}}>
              <Defs>
                <ClipPath id="clip">
       ...
       return (
         <View>
           <Svg ref={this.props.getRef} style={{backgroundColor:this.props.backgroundColor,height:this.props.size,width:this.props.size}}>
            <Defs>
              <ClipPath id="clip">
                {makePieces()}
              </ClipPath>
